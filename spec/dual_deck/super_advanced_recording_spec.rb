...
describe 'super advanced dual deck recording' do
  ...
  let(:app) do
    Rack::Builder.new do
      use DualDeck::RackMiddleware, replay: true, feature: "feature_under_test", insecure_random: true
